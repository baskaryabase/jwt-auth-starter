...
1.[Running server seperately](#running-server-seperately)
2.[Integrating the server with the working project](#integrating-the-server-with-the-working-project)
